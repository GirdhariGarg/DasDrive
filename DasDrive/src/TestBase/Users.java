	...
	public void validate(int row) throws IOException, InterruptedException {
		...
		case "y":
			...
			case "AUT_02": // validate test case
				try{
				driver.findElement(By.linkText(usersIDlink)).click();
				Assert.assertEquals(driver.getPageSource().contains(expectedresult), true, "" + xltcdata.setCellData(TDSheet, TDResult, row,"Fail"));
				xltcdata.setCellData(TDSheet, TDResult, row, "Pass");
				System.out.println("TestCase Passed With Expected Reuslt" + expectedresult);
				}
			...
			case "AUT_03": // validate test case
				try{
				driver.findElement(By.linkText(usersEmailadlink)).click();
				Assert.assertEquals(driver.getPageSource().contains(expectedresult), true, "" + xltcdata.setCellData(TDSheet, TDResult, row,"Fail"));
				xltcdata.setCellData(TDSheet, TDResult, row, "Pass");
				System.out.println("TestCase Passed With Expected Reuslt" + expectedresult);
				}
			...
			case "AUT_04": // validate test case
				try{
				driver.findElement(By.linkText(usersFullNamelink)).click();
				Assert.assertEquals(driver.getPageSource().contains(expectedresult), true, "" + xltcdata.setCellData(TDSheet, TDResult, row,"Fail"));
				xltcdata.setCellData(TDSheet, TDResult, row, "Pass");
				System.out.println("TestCase Passed With Expected Reuslt" + expectedresult);
				}
			...
			case "AUT_05": // validate test case
				try{
				driver.findElement(By.linkText(usersActivelink)).click();
				Assert.assertEquals(driver.getPageSource().contains(expectedresult), true, "" + xltcdata.setCellData(TDSheet, TDResult, row,"Fail"));
				xltcdata.setCellData(TDSheet, TDResult, row, "Pass");
				System.out.println("TestCase Passed With Expected Reuslt" + expectedresult);
				}
			...
			case "AUT_06": // validate test case
				try{
				driver.findElement(By.linkText(usersRolelink)).click();
				Assert.assertEquals(driver.getPageSource().contains(expectedresult), true, "" + xltcdata.setCellData(TDSheet, TDResult, row,"Fail"));
				xltcdata.setCellData(TDSheet, TDResult, row, "Pass");
				System.out.println("TestCase Passed With Expected Reuslt" + expectedresult);
				}
			...
			case "AUT_09": // validate test case
				try{
				driver.findElement(By.linkText(usersExpirylink)).click();
				Assert.assertEquals(driver.getPageSource().contains(expectedresult), true, "" + xltcdata.setCellData(TDSheet, TDResult, row,"Fail"));
				xltcdata.setCellData(TDSheet, TDResult, row, "Pass");
				System.out.println("TestCase Passed With Expected Reuslt" + expectedresult);
				}
			...
			case "AUT_10": // validate test case
				try{
				driver.findElement(By.linkText(usersModifiedlink)).click();
				Assert.assertEquals(driver.getPageSource().contains(expectedresult), true, "" + xltcdata.setCellData(TDSheet, TDResult, row,"Fail"));
				xltcdata.setCellData(TDSheet, TDResult, row, "Pass");
				System.out.println("TestCase Passed With Expected Reuslt" + expectedresult);
				}
			...
			case "AUT_11": // validate test case
				...
				driver.findElement(By.linkText(userseditRGTab)).click();
				Assert.assertEquals(driver.getPageSource().contains(expectedresult), true, "" + xltcdata.setCellData(TDSheet, TDResult, row,"Fail"));
				xltcdata.setCellData(TDSheet, TDResult, row, "Pass");
				System.out.println("TestCase Passed With Expected Reuslt" + expectedresult);
				}
			...
			case "AUT_12": // validate test case
				try{
				driver.findElement(By.xpath(userseditb)).click();
				driver.findElement(By.xpath(userseditpass)).sendKeys(parameter3);
				driver.findElement(By.xpath(userseditrepass)).sendKeys(parameter4);
				driver.findElement(By.xpath(userseditsave));
			...
			case "AUT_13": // validate test case
				try{
				driver.findElement(By.xpath(usersCdeleteb)).click();
			...
			case "AUT_14": // validate test case
				try{
				driver.findElement(By.xpath(userseditb)).click(); 
				String ddddd = driver.findElement(By.xpath(userseditpassval)).getText();
				System.out.println(ddddd);
				
				Assert.assertEquals(driver.findElement(By.xpath(userseditpassval)).getText().contains(expectedresult), true, "" + xltcdata.setCellData(TDSheet, TDResult, row,"Fail"));
				xltcdata.setCellData(TDSheet, TDResult, row, "Pass");
				System.out.println("TestCase Passed With Expected Reuslt" + expectedresult);
				}
				catch(Throwable e){
			...
			case "AUT_15": // validate test case
				try{
				driver.findElement(By.xpath(usersemails)).click(); 
				Assert.assertEquals(driver.getPageSource().contains(expectedresult), true, "" + xltcdata.setCellData(TDSheet, TDResult, row,"Fail"));
				xltcdata.setCellData(TDSheet, TDResult, row, "Pass");
				System.out.println("TestCase Passed With Expected Reuslt" + expectedresult);
				}
